...
const Banner = () => {
    return (
        <div style={{backgroundImage: `url("https://i.ibb.co/k6sC3Hf/recepi-cover.jpg")`, backgroundSize: 'cover',backgroundRepeat: 'no-repeat'}} className='text-white lg:px-64  px-11 py-20 flex'>
